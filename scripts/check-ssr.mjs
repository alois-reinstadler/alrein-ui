...
const PAGES = ['/', '/fx', '/button', '/card', '/badge', '/input', '/textarea', '/checkbox', '/radio-group', '/switch', '/select', '/field', '/spinner', '/alert', '/tooltip', '/avatar', '/skeleton', '/chip', '/rating', '/button-group', '/steps', '/timeline', '/color-picker', '/code', '/code-window', '/upload-area'];
